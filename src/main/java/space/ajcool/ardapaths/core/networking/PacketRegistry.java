...
public class PacketRegistry {
    ...
    public static final ArdaPathsPermissionCheckHandler PERMISSION_CHECK = new ArdaPathsPermissionCheckHandler();
    ...
    public static void init() {
        ...
        PayloadTypeRegistry.playS2C().register(ArdaPathsPermissionCheckResponsePacket.ID, ArdaPathsPermissionCheckResponsePacket.CODEC);
        ...
        if (Fabric.isClient()) {
            ClientPlayNetworking.registerGlobalReceiver(
                    ArdaPathsPermissionCheckResponsePacket.ID, PERMISSION_CHECK::receiveOnClient);
            ClientPlayNetworking.registerGlobalReceiver(
